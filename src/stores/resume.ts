...
export interface BasicInfoFieldVisibility {
  name: boolean
  phone: boolean
  email: boolean
  avatar: boolean
...
export const useResumeStore = defineStore('resume', () => {
  ...
  const basicInfoFieldVisibility = reactive<BasicInfoFieldVisibility>({
    name: true,
    phone: true,
    email: true,
    avatar: true,
  ...
  function exportResumeData(): string {
    return JSON.stringify({
      ...
      basicInfo: { ...basicInfo },
      basicInfoFieldVisibility: { ...basicInfoFieldVisibility },
  ...
  function loadFromStorage() {
    ...
    try {
      ...
      if (data.basicInfoFieldVisibility) {
        Object.assign(basicInfoFieldVisibility, data.basicInfoFieldVisibility)
      }
  ...
  watch(
    [
      ...
      () => JSON.stringify(basicInfoFieldVisibility),
